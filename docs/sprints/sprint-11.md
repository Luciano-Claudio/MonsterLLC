...
- **`GameEvents.OnLootCollected` removido** (Seção 0 do task breakdown, "limpeza rápida antes de começar") — estava morto desde a Sprint 10, sem assinantes nem chamadores. Feito no primeiro commit da sprint (`5a9c5bf`), só não tinha sido citado neste relatório até a correção pós-Sprint 12.
